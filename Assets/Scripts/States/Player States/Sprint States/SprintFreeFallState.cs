...
[CreateAssetMenu(menuName = "Player State/Sprint State/Free Fall")]
public class SprintFreeFallState : BaseState<PlayerController>
{
    ...
    public override void OnStateCollisionEnter(Collision2D collision)
    {
        if (Runner.GetGroundCheck().Check()){
            ...
            CurrentSuperState.SetSubState(CurrentSuperState.GetState(typeof(SprintFreeFallLandState)), collision.relativeVelocity.y);
        }
    }
