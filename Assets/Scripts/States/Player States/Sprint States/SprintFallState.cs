...
[CreateAssetMenu(menuName = "Player State/Sprint State/Fall")]
public class SprintFallState : BaseState<PlayerController>
{
    ...
    {   
        if (attackControl > 0) {
            ...
            CurrentSuperState.SetSubState(CurrentSuperState.GetState(typeof(SprintFreeFallState)));
        }
    }
